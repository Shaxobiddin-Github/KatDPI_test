...
class Test(models.Model):
    ...
    kafedralar = models.ManyToManyField('Kafedra', blank=True, related_name='multi_tests', verbose_name='Biriktirilgan kafedralar')
    bulim = models.ForeignKey('Bulim', on_delete=models.SET_NULL, null=True, blank=True, related_name='tests', verbose_name="Bo'lim")
    bulimlar = models.ManyToManyField('Bulim', blank=True, related_name='multi_tests', verbose_name="Biriktirilgan bo'limlar")
